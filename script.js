document.addEventListener('DOMContentLoaded', () => {
    ...
    function init() {
        ...
        formWrapper.addEventListener('click', (e) => {
            const button = e.target.closest('button, .avatar-tab, .icon-option, .layout-card, .color-dot, .gradient-swatch');
            if (!button) return;
