document.addEventListener('DOMContentLoaded', () => {
    ...
    let cvData = {
        layout: 'classic',
        themeColor: '#dc3545', // Rojo por defecto para que coincida con la imagen
    ...
    (function buildTemplateAndFormFunctions(){
        ...
        const renderGenericSection = (title, items, renderItemFn, color) => {
             if (!items || items.length === 0) return '';
             return `<div style="margin-top:1.5rem">
                        <h3 style="font-family: var(--font-heading); font-size:1rem; font-weight:600; color:${color}; border-bottom:2px solid ${color}; padding-bottom:.25rem; margin-bottom:1rem; display:inline-block; text-transform: uppercase;">${title}</h3>
        ...
        formRenderers.design = () => { const hexColor = cvData.themeColor.startsWith('#') ? cvData.themeColor : '#dc3545'; renderForm(`<div class="form-section" data-section="design"><h2 class="section-title">Diseño y Apariencia</h2><p class="section-subtitle">Personaliza cómo se ve tu currículum.</p><div class="subsection-title">Color de Acento</div><div class="theme-selector"><div class="colors"><div class="color-dot ${cvData.themeColor==='#0d6efd'?'active':''}" data-color-value="#0d6efd" style="background:#0d6efd"></div><div class="color-dot ${cvData.themeColor==='#198754'?'active':''}" data-color-value="#198754" style="background:#198754"></div><div class="color-dot ${cvData.themeColor==='#6f42c1'?'active':''}" data-color-value="#6f42c1" style="background:#6f42c1"></div><div class="color-dot ${cvData.themeColor==='#dc3545'?'active':''}" data-color-value="#dc3545" style="background:#dc3545"></div><div class="color-dot ${cvData.themeColor==='#525f7f'?'active':''}" data-color-value="#525f7f" style="background:#525f7f"></div><div class="color-dot ${cvData.themeColor==='#e83e8c'?'active':''}" data-color-value="#e83e8c" style="background:#e83e8c"></div><input type="color" id="custom-color-picker" value="${hexColor}"></div></div><div class="subsection-title">Plantilla del CV</div><div class="layout-selector"><div class="layout-card ${cvData.layout==='classic'?'active':''}" data-layout="classic"><img src="https://i.imgur.com/rXBi2JN.png" alt="Clásico"><p>Clásico</p></div><div class="layout-card ${cvData.layout==='modern'?'active':''}" data-layout="modern"><img src="https://i.imgur.com/6ZweVTE.png" alt="Moderno"><p>Moderno</p></div><div class="layout-card ${cvData.layout==='compact'?'active':''}" data-layout="compact"><img src="https://i.imgur.com/vHExj4B.png" alt="Compacto"><p>Compacto</p></div><div class="layout-card ${cvData.layout==='executive'?'active':''}" data-layout="executive"><img src="https://i.imgur.com/H0nJtVf.png" alt="Ejecutivo"><p>Ejecutivo</p></div><div class="layout-card ${cvData.layout==='creative'?'active':''}" data-layout="creative"><img src="https://i.imgur.com/152eA6A.png" alt="Creativo"><p>Creativo</p></div><div class="layout-card ${cvData.layout==='minimalist'?'active':''}" data-layout="minimalist"><img src="https://i.imgur.com/uC5iF5v.png" alt="Minimalista"><p>Minimalista</p></div><div class="layout-card ${cvData.layout==='corporate'?'active':''}" data-layout="corporate"><img src="https://i.imgur.com/v8CoKg4.png" alt="Corporativo"><p>Corporativo</p></div><div class="layout-card ${cvData.layout==='technical'?'active':''}" data-layout="technical"><img src="https://i.imgur.com/39w8A1N.png" alt="Técnico"><p>Técnico</p></div><div class="layout-card ${cvData.layout==='infographic'?'active':''}" data-layout="infographic"><img src="https://i.imgur.com/8Qp4kXm.png" alt="Infográfico"><p>Infográfico</p></div><div class="layout-card ${cvData.layout==='academic'?'active':''}" data-layout="academic"><img src="https://i.imgur.com/p51aSP9.png" alt="Académico"><p>Académico</p></div></div></div>`);};
    ...
    const renderCVPreview = () => {
        ...
        const templateFn = templates[layout] || templates.classic; // Fallback to classic
    ...
    function init() {
        ...
        setActiveSection('design'); // Iniciar en la sección de diseño para ver los cambios
        renderCVPreview();
    }
